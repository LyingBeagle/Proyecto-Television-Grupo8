...
public class Menu {
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            System.out.println("  6. Mostrar paquetes según popularidad");
            ...
            switch (opcion) {
                ...
                case 6:
                    if (clientes.isEmpty()) {
                        ...
                        System.out.println("Mostrando paquetes según popularidad:");
                        System.out.println("Paquete A - 50% de los clientes");
                        System.out.println("Paquete B - 30% de los clientes");
                        System.out.println("Paquete C - 20% de los clientes");
                    }
                    break;
